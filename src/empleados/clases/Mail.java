...
public class Mail {
    private String user="1erdaw2015@gmail.com", pass= "villadaw", destino, subject="Gracias por confiar en Outlet Products", mensaje="esta es tu contraseña, apuntala y luego elimina el mensaje", contrasena;
    private Properties props;

    //public Mail(String vuser, String vpass, String vdestino, String vsubject, String vmensaje) {
    public Mail(String vdestino, String vpass) {
    ...
    public String send() {
        ...
        try {
            ...
            mimebodypart1.setContent("<html><font color='#AA00FF'>tu contraseña de registro es:"+contrasena+" "+mensaje+"<br> Mensaje enviado "+new java.util.Date()+"</font></html>", "text/html");
